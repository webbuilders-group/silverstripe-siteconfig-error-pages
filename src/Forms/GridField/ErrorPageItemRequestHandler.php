...
class ErrorPageItemRequestHandler extends GridFieldDetailForm_ItemRequest
{
    ...
    public function archive($data, Form $form)
    {
        ...
        if ($toplevelController && $toplevelController instanceof LeftAndMain) {
            ...
            $backForm->sessionMessage(_t('WebbuildersGroup\\SiteConfigErrorPages\\Forms\\GridField\\ErrorPageItemRequestHandler.ARCHIVEDPAGE', "Archived error page '{title}'", ['title' => $record->Title]), 'good');
        } else {
            $form->sessionMessage(_t('WebbuildersGroup\\SiteConfigErrorPages\\Forms\\GridField\\ErrorPageItemRequestHandler.ARCHIVEDPAGE', "Archived error page '{title}'", ['title' => $record->Title]), 'good');
        }
